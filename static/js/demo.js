...
function charts() {
	...
	{	
		var likes = [[1, 10020], [2, 12732], [3,18943], [4,20136],[5, 25432],[6,26781],[7, 27002],[8,34020],[9, 35784],[10,38777],[11, 40021],[12,43321],[13,44121],[14, 49870],[15,53780],[16,54367],[17,57862],[18, 58050],[19,59000],[20,59923],[21,60102],[22,61276],[23,62980],[24,64001],[25,65561],[26,68016],[27,69452],[28, 71862],[29,73011], [30,74665]];

		var plot = $.plot($("#accumulated"),
			   [ { data: likes, label: "누적다운로드수"} ], {
				   series: {
					   lines: { show: true,
								lineWidth: 2,
				   ...
				   colors: ["#3B5998"],
					xaxis: {ticks:[[0,"5/10"],[5,"5/20"],[10,"5/30"],[15,"6/10"],[20,"6/20"],[25,"6/30"],[30,"7/10"]]},
		...
		var previousPoint = null;
		$("#accumulated").bind("plothover", function (event, pos, item) {
			$("#x").text(pos.x.toFixed(2));
			$("#y").text(pos.y.toFixed(2));
	...
	if($("#stackchartdemo").length)
	{
		...
		var d5 = [];
		for (var i = 0; i <= 10; i += 1)
			d5.push([i, parseInt(Math.random() * 100)]);

		var stack = 10, bars = true, lines = false, steps = true;

		function plotWithOptions() {
			$.plot($("#stackchartdemo"), [  { data: d1, label: "AppStore1"},{ data: d2, label: "Appstore2"},{ data: d3, label: "Appstore3"},{ data: d4, label: "Appstore4"},{ data: d5, label: "Appstore5"}  ],{
				series: {
					stack: stack,
					lines: { show: lines, fill: true, steps: steps },
					bars: { show: bars, barWidth: 0.6, align:"center" },
				},
				xaxis:{ticks:[[0,"6/11"],[1,"6/12"],[2,"6/13"],[3,"6/14"],[4,"6/15"],[5,"6/16"],[6,"6/17"],[7,"6/18"],[8,"6/19"],[9,"6/20"],[10,"6/21"]]},
				legend: {
                    show: true
                },
				grid:{
		...
		$("#stackchartdemo").bind("plothover", function (event, pos, item) {
	...
	{ label: "QQ",  data: 27},
	{ label: "Baidu",  data: 85},
	{ label: "Wechat",  data: 64},
	{ label: "Wandouajia",  data: 90}
	];
	
	if($("#piechartdemo").length)
	{
		$.plot($("#piechartdemo"), data,
		{
			series: {
					pie: {
							show: true
